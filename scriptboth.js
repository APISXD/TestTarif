...
document.getElementById("jenisKereta").addEventListener("change", function () {
  var jenisKereta = this.value;
  var stasiunGroupKRLS = document.getElementById("stasiunGroupKRL");
  if (jenisKereta === "KRL") {
    stasiunGroupKRLS.style.display = "block";
    populateStasiunOptions();
  } else {
    stasiunGroupKRLS.style.display = "none";
    // Clear the options for stasiunAwal and stasiunAkhir when jenisKereta is not MRT or BOTH
    document.getElementById("st-from").innerHTML = "";
    document.getElementById("st-to").innerHTML = "";
  }
});
